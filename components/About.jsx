    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            Even as a kid, I am always striving to explore new fields and just
            be curious in general. Continously looking for new skills and
            knowledge to gain. I thought it would be a great challenge for
            myself to learn how to code. So for the past few months, that is
            exactly what I did which resulted in various projects including this
            website.
          </p>
